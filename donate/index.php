...
<html lang="en">
  ...
  <section id="nav-bar">
      <nav class="navbar navbar-expand-lg navbar-light bg-light">
          <a class="navbar-brand text-white" href="/index.html"><i class="fas fa-handshake fa-small"></i><strong>  Give A Hand</strong></a>
          ...
          <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
              <li class="nav-item active">
                <a class="nav-link ml-1 text-white" style="border-radius: 20%;" href="/index.html">HOME<span class="sr-only">(current)</span></a>
              </li>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 text-center">
                    <img src="img/saving.svg" alt="ambulance" class="img-fluid">
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="services">
        <div class="container text-center">
           <h1 class="title">WHY SHOULD YOU DONATE?</h1> 
            <div class="row">
                <div class="col-md-4">
                    <img src="img/saving.svg" class="img-fluid" id="img1">
...
Donate now through a completely secured, easy mode of payment so that the money reaches the person.</p>
                ...
                <div class="col-md-4">
                    <img src="img/ambulance.jpg" class="img-fluid" id="img2">
...
All donations will directly be utilised towards nuclear disaster management and sending emergency kits, food and basic emenities to those in need ! </p>
                ...
                <div class="col-md-4">
                    <img src="img/gifts.svg" class="img-fluid" id="img3">
            ...
            <div class="row">
                ...
                <div class="col-md-4 ">
                    <div class="stat-items" id="totalvolunteer">
                        <img src="img/people.svg" class="img-fluid">
                ...
                <div class="col-md-4 ">
                    <div class="stat-items" id="totalneeded">
                        <img src="img/wallet.svg" class="img-fluid">
                        <br><br>
